...
yay -S --needed --noconfirm \
    pipewire wireplumber neofetch qt5ct kitty qt6ct mako waybar swww swaylock-effects mpv bat \
    wofi wlogout gtklock dunst ncmpcpp mpd firefox macchina swappy grim slurp neovim \
    neovide vim ranger thunar btop firefox thunderbird mpv kvantum htop hyprland-git \
    waybar-hyprland-git swaync deadd-notification-center starship papirus-icon-theme \
    cava lxappearance xfce4-settings nwg-look-bin sddm eww-wayland aylurs-gtk-shell \
    google-chrome rofi-lbonn-wayland-git chatgpt-desktop-bin spotify gtk3 gtk2 gtk4 \
    mako picom starship fish zsh pyprland aconfmgr mpvpaper python-pywal imagemagick
